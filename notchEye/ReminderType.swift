...
final class ReminderStore {
    ...
    func delete(at offsets: IndexSet) {
        ...
        save()
        for id in ids {
            NotificationCenter.default.post(name: .notechItemDeleted, object: nil, userInfo: ["itemId": id])
        }
    }
    ...
    func delete(_ item: ReminderItem) {
        ...
        save()
        NotificationCenter.default.post(name: .notechItemDeleted, object: nil, userInfo: ["itemId": item.id])
    }
